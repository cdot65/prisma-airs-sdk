...
| gateway-realtime | 3 | 1 | 0 | 4 | 2026-09-06 23:47:14.326Z |
...
- Executable documentation: every one of the 21 scripts in docs-site/examples/ (excluding the shared helper), including 4 explicitly mock-backed scripts, plus 3 live sanitized scan-response captures. Real outputs, failures, and mock/live distinctions appear on the examples, Scan API, and OAuth lifecycle pages.
