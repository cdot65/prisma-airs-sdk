...
| --- | --- | --- |
| `client.dlp.dataFilteringProfiles` | list, get, full replace | [Data Filtering Profiles](dlp/data-filtering-profiles) |
| `client.dlp.dataPatterns` | list, create, get, replace, patch, delete | [Data Patterns](dlp/data-patterns) |
| `client.dlp.dataProfiles` | list, create, get, replace, patch | [Data Profiles](dlp/data-profiles) |
| `client.dlp.dictionaries` | list, multipart create, get, multipart replace, patch, delete | [Dictionaries](dlp/dictionaries) |
