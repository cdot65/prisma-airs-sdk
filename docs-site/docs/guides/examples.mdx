...
Captured **2026-09-06T18:51:22.545Z** by the separate batch E2E workflow, which passed 9/9 checks. This is additional runtime evidence, not an extra script in the 22-script table above.
