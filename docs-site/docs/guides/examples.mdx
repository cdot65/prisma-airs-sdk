...
The SDK **0.25.0** installed-package check passes **102/102** at **2026-09-07T11:30:23.092Z**, using **installed-sdk**. The independent raw SCM run passes **102/102** at **2026-09-07T11:10:38.954Z**. Both use existing owned positive traffic, with no new inference, keys, logs or configuration changes. These are installed-package checks; registry publication is a separate release gate.
